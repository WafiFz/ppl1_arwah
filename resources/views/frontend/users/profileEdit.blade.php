                ...
                <div class="px-4 sm:px-0">
                    ...
                    <p class="pt-4">
                        <a href="{{ route('frontend.users.profile', encode_id($$module_name_singular->id)) }}">
                            <div
                                class="w-full text-center px-6 py-2 transition ease-in duration-200 rounded text-gray-500 hover:bg-gray-800 hover:text-white border-2 border-gray-900 focus:outline-none">
                                @lang('View Profile')
                            </div>
                        </a>
                    </p>
                    ...
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-4">
                                ...
                                <div class="sm:pt-6">
                                    <input
                                        class="border-gray-300 focus:ring-blue-600 block w-full overflow-hidden cursor-pointer border text-gray-800 bg-white rounded-md shadow-sm focus:outline-none focus:ring-2 focus:border-transparent"
                                        aria-describedby="avatar" id="avatar" name="avatar" type="file">
                                </div>
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                <input
                                    class="mt-1 border-gray-300 w-full py-2 px-4 bg-gray-200 text-gray-700 placeholder-gray-300 rounded border shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent"
                    ...
                    <div class="px-4 py-3 bg-gray-50 text-end sm:px-6">
                        <button type="submit"
                            class="inline-flex w-full justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            Save
                        </button>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 text-center">
                                    <a
                                        ...
                                        <div
                                            class="w-full text-sm px-6 py-2 transition ease-in duration-200 rounded text-gray-500 hover:bg-gray-800 hover:text-white border-2 border-gray-900 focus:outline-none">
                                            Change Password
                                        </div>
                                    </a>
                                </div>
