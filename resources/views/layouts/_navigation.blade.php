<nav id="main-nav" class="fixed top-0 left-0 right-0 z-50" x-data="{ showMobileNav: false }">
                ...
                <div class="relative ml-3" x-data="{ isUserMenuOpen: false }">
                    <div class="flex flex-row gap-2">
                        <x-button-a href="{{ route('order.index') }}"
                            class="invisible px-6 tracking-normal text-white capitalize transition-colors duration-200 transform !rounded-full bg-brand-purple-500 hover:bg-brand-yellow-500 hover:text-black md:visible">
        ...
        <div id="nav-dark" class="container hidden py-2 mx-auto">
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex items-center content-center justify-center flex-1 sm:items-stretch sm:justify-between">
                    ...
                    <div class="hidden sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            <a href="{{route('home')}}#paket" class="nav-link">
                                Paket
                            </a>
                            <a href="{{route('home')}}#portfolio" class="nav-link">
                                Portfolio
                            </a>
                            <a href="{{route('home')}}#tema" class="nav-link">
                                Tema
                            </a>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    <div class="relative ml-3" x-data="{ isUserMenuOpen: false }">
                        <div class="flex flex-row gap-2">
                            <x-button-a href="{{ route('order.index') }}"
                                class="font-medium invisible px-6 tracking-normal capitalize transition-colors duration-200 transform bg-white !rounded-full text-brand-purple-500 hover:bg-brand-yellow-500 hover:text-black md:visible">
                                <span class="mx-1">Pesan Sekarang</span>
                            </x-button-a>
                            @guest
                                <x-button-a href="{{ route('login') }}"
                                    class="font-medium invisible px-6 tracking-normal text-white capitalize transition-colors duration-200 transform !rounded-full bg-brand-purple-500 ring-1 ring-white hover:ring-0 hover:text-black hover:bg-brand-yellow-500 md:visible">
                                    <span class="mx-1">{{ __('Login') }}</span>
                                </x-button-a>
                            @else
                                <button @click="isUserMenuOpen = !isUserMenuOpen" @keydown.escape="isUserMenuOpen = false"
