<x-member-layout title="Profile">
    <main class="grow">
        ...
        <form action="{{ route('client.updatePassword', encode_id(auth()->user()->id)) }}" method="post" enctype="multipart/form-data">
            @csrf
            <section class="bg-white">
                <div class="container py-8">
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <x-input id="password" class="block w-full mt-1" type="password" name="password" placeholder="Password" required />
                        </div>
                    </div>
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        <div class="sm:w-1/3">
                        ...
                        <div class="sm:w-2/3">
                        <x-input id="new_password" class="block w-full mt-1" type="password" name="new_password" placeholder="Password Baru" required />
                        </div>
                    </div>
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        <div class="sm:w-1/3">
                        ...
                        <div class="sm:w-2/3">
                            <x-input id="new_password_confirmation" class="block w-full mt-1" type="password" name="new_password_confirmation" placeholder="Konfirmasi Password Baru" required />
                        </div>
                    </div>
