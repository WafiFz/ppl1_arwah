            ...
            <section class="bg-white">
                <div class="container py-8">
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <input type="text" name="status" value="{{ $data->invitation->type }}" x-model=""
                                class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <input type="date" name="created_at" value="{{ $data->created_at }}" x-model=""
                                class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <input type="text" name="package_name" value="{{ $data->package->name }}" x-model=""
                                class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <input type="text" name="status" value="{{ $data->invitation->status }}" x-model=""
                                class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <input type="text" name="slug" value="{{ $data->invitation->slug }}" x-model=""
            ...
            <section class="bg-white">
                <div class="container py-8">
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <input type="text" name="location" value="{{ $data->invitation->wedding->location }}"
                                x-model=""
                                class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                        ...
                        <div class="sm:w-2/3">
                            <div>
                                ...
                                <input type="text" name="date"
                                    value="{{ $data->invitation->wedding->event[0]->date }}" x-model=""
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex flex-col items-center gap-2 sm:flex-row mt-1.5">
                                    <input type="text" name="start_time"
                                        value="{{ $data->invitation->wedding->event[0]->start_time }}" x-model=""
                                        class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                                        :disabled="isEdit() ? false : true"
                                        :class="isEdit() == false && 'bg-neutral-100'" />
                                    -
                                    <input type="text" name="end_time"
                                        value="{{ $data->invitation->wedding->event[0]->end_time }}" x-model=""
                                        class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                                        :disabled="isEdit() ? false : true"
                                        :class="isEdit() == false && 'bg-neutral-100'" />
                                </div>
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex flex-col items-center gap-2 sm:flex-row mt-1.5">
                                    <input type="text" name="start_time"
                                        value="{{ $data->invitation->wedding->event[1]->start_time }}" x-model=""
                                        class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                                        :disabled="isEdit() ? false : true"
                                        :class="isEdit() == false && 'bg-neutral-100'" />
                                    -
                                    <input type="text" name="end_time"
                                        value="{{ $data->invitation->wedding->event[1]->end_time }}" x-model=""
                                        class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                                        :disabled="isEdit() ? false : true"
                                        :class="isEdit() == false && 'bg-neutral-100'" />
                                </div>
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <div>
                                <span class="font-semibold">Tanggal</span>
                                <input type="text" name="date"
                                    value="{{ $data->invitation->wedding->event[2]->date }}" x-model=""
                                    class="mt-1.5 block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                                    :disabled="isEdit() ? false : true"
                                    :class="isEdit() == false && 'bg-neutral-100'" />
                            </div>
                            <div class="mt-4">
                                ...
                                <div class="flex flex-col items-center gap-2 sm:flex-row mt-1.5">
                                    <input type="text" name="start_time"
                                        value="{{ $data->invitation->wedding->event[2]->start_time }}" x-model=""
                                        class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                                        :disabled="isEdit() ? false : true"
                                        :class="isEdit() == false && 'bg-neutral-100'" />
                                    -
                                    <input type="text" name="end_time"
                                        value="{{ $data->invitation->wedding->event[2]->end_time }}" x-model=""
                                        class="block min-h-[auto] rounded border border-gray-300 py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear motion-reduce:transition-none w-full"
                                        :disabled="isEdit() ? false : true"
                                        :class="isEdit() == false && 'bg-neutral-100'" />
                                </div>
            ...
            <section class="bg-white">
                <div class="container py-8">
                    ...
                    <div class="justify-between mt-5 sm:flex">
                        ...
                        <a class="text-brand-purple-500" href="">Lihat lebih banyak <i class="fa-solid fa-arrow-right-long"></i></a>
                    </div>
                </div>
            </section>
        </form>
