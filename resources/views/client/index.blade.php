            ...
            <div class="container py-8">
                <div class="flex flex-col gap-2.5 py-4 border-t border-gray-200 sm:flex-row">
                    ...
                    <div class="flex items-center sm:w-2/3">
                        <x-button-a href="#" class="w-full py-3 tracking-wide capitalize transition-colors duration-200 transform bg-white ring-1 ring-brand-purple-500 hover:ring-0 hover:text-black hover:bg-brand-yellow-500">
