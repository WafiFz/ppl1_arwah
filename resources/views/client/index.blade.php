            ...
            <section class="bg-white">
                <div class="container py-8">
                    ...
                    <div class="flex flex-col gap-1.5 py-4 border-t border-gray-200 sm:flex-row">
                        ...
                        <div class="sm:w-2/3">
                            <input name="avatar" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" :disabled="isEdit() ? false : true">
