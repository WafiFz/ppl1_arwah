    ...
    <section class="flex items-center py-10">
        <div class="container">
            ...
            <div class="flex justify-end gap-2 mt-8">
                ...
                <x-button-a href="{{ route('order.checkout', encode_id($data['theme']->id)) }}" class="w-full py-3 tracking-wide text-white transition-colors duration-200 transform sm:w-40 bg-brand-purple-500 hover:bg-brand-yellow-500 hover:text-black">
