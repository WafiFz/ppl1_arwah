<section id="testimoni" class="py-10 bg-brand-purple-500">
    <div class="container items-center md:flex">  
        <div class="w-full">
            <span class="text-white">Testimoni</span>
            <h2 class="mt-0 mb-2 text-4xl font-medium leading-tight text-brand-yellow-500">Apa Kata Mereka Tentang Kami</h2>
        </div>
        <div class="w-full min-w-0">
            <div class="relative w-full glide-testimoni">
                <!-- Slides -->
                <div class="overflow-hidden bg-white rounded shadow-lg shadow-slate-200 text-slate-500 " data-glide-el="track">
                    <ul class="relative w-full overflow-hidden p-0 whitespace-no-wrap flex flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] list-none">
                        <li>
                            <div class="w-full">
                                <!-- Start Testimonial -->
                                <div class="overflow-hidden ">
                                    <div class="relative p-3">
                                        <figure class="relative z-10">
                                            <figcaption class="flex flex-col items-start gap-2 p-6 pb-0 text-sm text-brand-purple-500">
...
@push('after-javascript')
    <script>
        var glideTestimoni = new Glide('.glide-testimoni', {
            type: 'slider',
            focusAt: 'center',
            perView: 1,
            autoplay: 3500,
